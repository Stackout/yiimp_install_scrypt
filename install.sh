...
' | sudo -E tee /etc/nginx/blockuseragents.rules >/dev/null 2>&1
    ...
    echo rootpasswd > rootpasswd.log
...
' | sudo -E tee /etc/nginx/sites-available/$server_name.conf >/dev/null 2>&1
    ...
    Q3="FLUSH PRIVILEGES;"
    SQL="${Q1}${Q2}${Q3}"
    sudo mysql -u root -e "$SQL"-h mysql.helixalpha.com
...
' | sudo -E tee /etc/yiimp/keys.php >/dev/null 2>&1
    ...
    # import sql dump
    sudo zcat 2016-04-03-yaamp.sql.gz | sudo mysql -h mys
    
    # oh the humanity!
    sudo mysql -h mysql.helixalpha.com -u root --force < 2016-04-24-market_history.sql
    sudo mysql -h mysql.helixalpha.com -u root --force < 2016-04-27-settings.sql
    sudo mysql -h mysql.helixalpha.com -u root --force < 2016-05-11-coins.sql
    sudo mysql -h mysql.helixalpha.com -u root --force < 2016-05-15-benchmarks.sql
    sudo mysql -h mysql.helixalpha.com -u root --force < 2016-05-23-bookmarks.sql
    sudo mysql -h mysql.helixalpha.com -u root --force < 2016-06-01-notifications.sql
    sudo mysql -h mysql.helixalpha.com -u root --force < 2016-06-04-bench_chips.sql
    sudo mysql -h mysql.helixalpha.com -u root --force < 2016-11-23-coins.sql
    sudo mysql -h mysql.helixalpha.com -u root --force < 2017-02-05-benchmarks.sql
    sudo mysql -h mysql.helixalpha.com -u root --force < 2017-03-31-earnings_index.sql
    sudo mysql -h mysql.helixalpha.com -u root --force < 2017-05-accounts_case_swaptime.sql
    sudo mysql -h mysql.helixalpha.com -u root --force < 2017-06-payouts_coinid_memo.sql
    sudo mysql -h mysql.helixalpha.com -u root --force < 2017-09-notifications.sql
    sudo mysql -h mysql.helixalpha.com -u root --force < 2017-10-bookmarks.sql
    sudo mysql -h mysql.helixalpha.com -u root --force < 2017-11-segwit.sql
    sudo mysql -h mysql.helixalpha.com -u root --force < 2018-01-stratums_ports.sql
    sudo mysql -h mysql.helixalpha.com -u root --force < 2018-02-coins_getinfo.sql
